...
* **Application** refers to LinguoBook, the software program provided by the Company.
* **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to LinguoBook.
...
When You purchase a subscription or product within the Application, payment processing is handled directly by the Google Play Store or Apple App Store. We do not collect or store your financial payment details (such as full credit card numbers).

However, We collect and process data related to Your purchases and subscriptions (such as transaction IDs, purchase time, subscription plan type, and expiration dates) using third-party services like RevenueCat to validate, manage, and deliver Your subscription benefits across Your devices.

**Advertising and Device Identifiers**

Our Application displays advertisements provided by Google AdMob. AdMob may collect and process information about Your Device and interaction with ads, including:

* Device Advertising Identifiers (such as Google Advertising ID / GAID or Apple IDFA)
* IP address and general geographic location
* Interaction data with advertisements (clicks, impressions)

This data is used to serve, personalize, and measure the effectiveness of advertisements displayed within the Service, as well as to prevent fraud.
...
* **With Service Providers:** We may share Your Personal Data with Service Providers to monitor, analyze, monetize, and support the operation of our Service, as detailed below:
  * **Google AdMob:** We use Google AdMob to serve advertisements within the Application. Google AdMob uses device identifiers and data processing to serve personalized or non-personalized ads, perform analytics, and prevent fraud. For more details on how Google uses data, visit [https://policies.google.com/privacy](https://policies.google.com/privacy)
  * **RevenueCat:** We use RevenueCat to handle and track in-app purchases, manage subscription statuses, and verify user entitlements. RevenueCat processes app user IDs and purchase histories. For more information, visit [https://www.revenuecat.com/privacy](https://www.revenuecat.com/privacy)
...
You may update, amend, or delete Your information at any time by signing in to Your Account, if you have one, and visiting the account settings section that allows you to manage Your personal information. You may also contact Us to request access to, correct, or delete any Personal Data that You have provided to Us via [this form](https://docs.google.com/forms/d/e/1FAIpQLScKktmdzTrVjUrzg5CZ3eyS2xAEjyd78-dTEz7vBj0Ourrmyg/viewform?usp=dialog).
